...
FilzaApplySandboxExt_FILES = Tweak.m AYLicenseGate.m sandbox_escape.m apfs_own.m
...
FilzaApplySandboxExt_FRAMEWORKS = UIKit Foundation Security IOKit CoreFoundation
